...
#define L298N_enA 9  //LEFT
#define L298N_enB 11 //RIGHT

#define L298N_in4 8  //RIGHT
#define L298N_in3 7  //RIGHT
#define L298N_in2 13  //LEFT
#define L298N_in1 12  //LEFT
...
void loop() {
  ...
  {
    right_wheel_meas_vel = (10 * right_encoder_counter * (60.0/176)) * 0.10472;
    left_wheel_meas_vel = (10 * left_encoder_counter * (60.0/176)) * 0.10472;
